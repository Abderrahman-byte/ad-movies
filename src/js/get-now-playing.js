...
export const getNowPlaying = (page) => {
    ...
    let urlTo = "https://api.themoviedb.org/3/movie/now_playing?api_key=ee0d8e2455cdf5f9d57bd5da132d19df&language=en-US&page=" + page;
    ...
    .then((arr) => {
        ...
        arrayOfResults.forEach((media) => {
            contentDiv.appendChild(new movieDiv(media.id, media.title, media.name, media.poster_path, media.overview, media.release_date, "movie"));
        });
        window.scrollTo(0, 0);
    })
    .then(() => {
